...
function draw() {
  ...
  if (filled) {
    ...
    textAlign(CENTER);
    text("N E L S O N", (windowWidth / 2), ((windowHeight/1.6)));
    stroke(234, 114, 140);
    strokeWeight(2);
    textSize(windowWidth/20);
    textAlign(CENTER);
    text("LOCATION: Chicago, IL", (windowWidth / 2), ((windowHeight / 1.4)));
  ...
  // margin border
  translate(((windowWidth/10)), ((windowHeight / 2.5)));
